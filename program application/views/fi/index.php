...
<div class="content-wrapper">
  ...
  <div class="container-fluid flex-grow-1 container-p-y">
    <!-- Data Tables -->
    <div class="card">
      <h5 class="card-header pb-0">Objectives & Key Results (OKR) Divisi Operasional FI</h5>
      <div class="m-3">
        <a href="<?php echo site_url('fi/create'); ?>" class="btn btn-primary ml-2 pl-2">
          ...
          <table class="table table-striped">
            ...
            <tbody class="table-border-bottom-0">
              ...
              <?php foreach ($fis as $fi): ?>
                <tr>
                  <td><?php echo $i; ?></td>
                  <td><?php echo $fi['objective_name']; ?></td>
                  <td><?php echo $fi['key_results']; ?></td>
                  <td><?php echo $fi['owner']; ?></td>
                  <td>
                    <?php
                    $weight = $fi['weight'];
                  ...
                  <td>
                    <a href="<?php echo site_url('fi/edit/' . $fi['id']); ?>" class="btn btn-primary">Edit</a>
                    <a href="#" class="btn btn-danger"
                      onclick="confirmDelete('<?php echo site_url('fi/delete/' . $fi['id']); ?>')">Delete</a>
                  </td>
                </tr>
                <?php $i++; ?>
              <?php endforeach; ?>
    ...
    <div class="row mt-3">
      ...
      <script>
        // Chart / Grafik
        const objectiveNames = <?php echo json_encode(array_column($fis, 'objective_name')); ?>;
        const progressData = <?php echo json_encode(array_column($fis, 'progress')); ?>;
      </script>
      <!--/ Overview Chart -->
