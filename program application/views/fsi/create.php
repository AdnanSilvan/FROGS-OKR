        ...
        <div class="col-xxl">
            <div class="card mb-6">
                <div class="card-header d-flex align-items-center justify-content-between">
                    <h5 class="mb-0">Create New | Objectives & Key Results (OKR) Divisi Operasional FSI </h5>
                </div>
                <?php if (validation_errors()): ?>
                    <div class="error"><?php echo validation_errors(); ?></div>
                <?php endif; ?>

                <?php echo form_open('fsi/create'); ?>
                <div class="card-body">
                    <form>
                        <div class="row mb-4">
                        ...
                        <div class="row justify-content-end">
                          <div class="col-sm-10">
                            ...
                            <a href="<?php echo site_url('fsi'); ?>" class="btn btn-secondary">Cancel</a>
                          </div>
                        </div>
                    </form>
                </div>
