...
<div class="content-wrapper">
  ...
  <div class="container-fluid flex-grow-1 container-p-y">
    ...
    <!-- Data Tables -->
    <div class="card">
      <h5 class="card-header pb-0">Objectives & Key Results (OKR) Divisi Bussiness Development</h5>
      <div class="m-3">
        <a href="<?php echo site_url('bussiness/create'); ?>" class="btn btn-primary">
          <span class="tf-icons ri-checkbox-circle-line ri-16px me-1_5"></span>Add New
        </a>
      </div>
      <div class="table-responsive text-nowrap">
        <?php if (!empty($bussinesss)): ?>
          <table class="table table-striped">
            ...
            <tbody class="table-border-bottom-0">
              <?php $i = 1; ?>
              <?php foreach ($bussinesss as $bussiness): ?>
                <tr>
                  <td><?php echo $i; ?></td>
                  <td><?php echo $bussiness['objective_name']; ?></td>
                  <td><?php echo $bussiness['key_results']; ?></td>
                  <td><?php echo $bussiness['owner']; ?></td>
                  <td>
                    <?php
                  ...
                  <td>
                    <a href="<?php echo site_url('bussiness/edit/' . $bussiness['id']); ?>" class="btn btn-primary">Edit</a>
                    <a href="#" class="btn btn-danger"
                      onclick="confirmDelete('<?php echo site_url('bussiness/delete/' . $bussiness['id']); ?>')">Delete</a>
                  </td>
                </tr>
                <?php $i++; ?>
              <?php endforeach; ?>
  ...
  <div class="row mt-3">
      ...
      <script>
        // Chart / Grafik
        const objectiveNames = <?php echo json_encode(array_column($bussinesss, 'objective_name')); ?>;
        const progressData = <?php echo json_encode(array_column($bussinesss, 'progress')); ?>;
      </script>
        ...
        <div class="card h-100">
          ...
          <div class="card-body">
            <table class="table">
              ...
              <tbody>
              <?php foreach ($bussinesss as $item): ?>
                <?php
