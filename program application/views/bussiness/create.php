        ...
        <div class="col-xxl">
            <div class="card mb-6">
                <div class="card-header d-flex align-items-center justify-content-between">
                    <h5 class="mb-0">Create New | Objectives & Key Results (OKR) Divisi Bussiness Development</h5>
                </div>
                <?php if (validation_errors()): ?>
                    <div class="error"><?php echo validation_errors(); ?></div>
                <?php endif; ?>

                <?php echo form_open('bussiness/create'); ?>
                <div class="card-body">
                    <form>
                        <div class="row mb-4">
                            ...
                            <div class="col-sm-10">
                                <div class="input-group input-group-merge">
                                    ...
                                    <input type="text" name="objective_name" class="form-control" id="basic-icon-default-fullname" value="<?php echo set_value('objective_name'); ?>"  />
                                </div>
                            </div>
                        </div>
                        <div class="row mb-4">
                            ...
                            <div class="col-sm-10">
                                <div class="input-group input-group-merge">
                                    ...
                                    <input type="text" name="key_results" id="basic-icon-default-keyresults" class="form-control" value="<?php echo set_value('key_results'); ?>"/>
                                </div>
                            </div>
                        </div>
                        <div class="row mb-4">
                            ...
                            <div class="col-sm-10">
                                <div class="input-group input-group-merge">
                                    ...
                                    <input type="text" name="owner" id="basic-icon-default-owner" class="form-control" value="<?php echo set_value('owner'); ?>" />
                                </div>
                            </div>
                        </div>
                        <div class="row mb-4">
                            ...
                            <div class="col-sm-10">
                                <div class="input-group input-group-merge">
                                    ...
                                    <input type="text" name="weight" id="basic-icon-default-weight" class="form-control" value="<?php echo set_value('weight'); ?>" />
                                </div>
                            </div>
                        </div>
                        <div class="row mb-4">
                            ...
                            <div class="col-sm-10">
                                <div class="input-group input-group-merge">
                                    ...
                                    <input type="text" name="target" id="basic-icon-default-target" class="form-control" value="<?php echo set_value('target'); ?>" />
                                </div>
                            </div>
                        </div>
                        <div class="row mb-4">
                            ...
                            <div class="col-sm-10">
                                <div class="input-group input-group-merge">
                                    ...
                                    <input type="text" name="actual" id="basic-icon-default-actual" class="form-control" value="<?php echo set_value('actual'); ?>" />
                                </div>
                            </div>
                        </div>
                        <div class="row mb-4">
                            ...
                            <div class="col-sm-10">
                                <div class="input-group input-group-merge">
                                    ...
                                    <input type="text" name="progress" id="basic-icon-default-progress" class="form-control" value="<?php echo set_value('progress'); ?>" />
                                </div>
                            </div>
                        </div>
                        <!-- Button -->
                        <div class="row justify-content-end">
                          <div class="col-sm-10">
                            ...
                            <a href="<?php echo site_url('bussiness'); ?>" class="btn btn-secondary">Cancel</a>
                          </div>
                        </div>
                    </form>
                </div>
