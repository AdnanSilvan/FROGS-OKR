    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="col-xxl">
            <div class="card mb-6">
                ...
                <?php echo form_open('bussiness/edit/' . $bussiness['id']); ?>
                <div class="card-body">
                    <form>
                        <div class="row mb-4">
                            <label class="col-sm-2 col-form-label" for="basic-icon-default-fullname">Objective
                                Name</label>
                            <div class="col-sm-10">
                                <div class="input-group input-group-merge">
                                    ...
                                    <input type="text" name="objective_name" class="form-control"
                                        id="basic-icon-default-fullname"
                                        value="<?php echo set_value('objective_name', $bussiness['objective_name']); ?>" />
                                </div>
                            </div>
                        </div>
                        <div class="row mb-4">
                            <label class="col-sm-2 col-form-label" for="basic-icon-default-keyresults">Key
                                Results</label>
                            <div class="col-sm-10">
                                <div class="input-group input-group-merge">
                                    ...
                                    <input type="text" name="key_results" id="basic-icon-default-keyresults"
                                        class="form-control"
                                        value="<?php echo set_value('key_results', $bussiness['key_results']); ?>" />
                                </div>
                            </div>
                        </div>
                        <div class="row mb-4">
                            ...
                            <div class="col-sm-10">
                                <div class="input-group input-group-merge">
                                    ...
                                    <input type="text" name="owner" id="basic-icon-default-owner" class="form-control"
                                        value="<?php echo set_value('owner', $bussiness['owner']); ?>" />
                                </div>
                            </div>
                        </div>
                        <div class="row mb-4">
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-sm-10">
                                <div class="input-group input-group-merge">
                                    ...
                                    <input type="text" name="progress" id="basic-icon-default-progress"
                                        class="form-control" value="<?php
                                        $progress = $bussiness['progress'];
