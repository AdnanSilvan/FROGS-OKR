...
<div class="content-wrapper">
  ...
  <div class="container-fluid flex-grow-1 container-p-y">
    ...
    <!-- Data Tables -->
    <div class="card">
      <h5 class="card-header pb-0">Objectives & Key Results (OKR) Divisi Finance Accounting Tax</h5>
      <div class="m-3">
        <a href="<?php echo site_url('finance/create'); ?>" class="btn btn-primary">
          ...
          <table class="table table-striped">
            ...
            <?php $i = 1; ?>
              <?php foreach ($finances as $finance): ?>
                <tr>
                  <td><?php echo $i; ?></td>
                  <td><?php echo $finance['objective_name']; ?></td>
                  <td><?php echo $finance['key_results']; ?></td>
                  <td><?php echo $finance['owner']; ?></td>
                  <td>
                    <?php
                  ...
                  <td>
                    <a href="<?php echo site_url('finance/edit/' . $finance['id']); ?>" class="btn btn-primary">Edit</a>
                    <a href="#" class="btn btn-danger"
                      onclick="confirmDelete('<?php echo site_url('finance/delete/' . $finance['id']); ?>')">Delete</a>
                  </td>
                </tr>
              <?php $i++; ?>
              <?php endforeach; ?>
    ...
    <div class="row mt-3">
      ...
      <script>
        // Chart / Grafik
        const objectiveNames = <?php echo json_encode(array_column($finances, 'objective_name')); ?>;
        const progressData = <?php echo json_encode(array_column($finances, 'progress')); ?>;
      </script>
      <!--/ Overview Chart -->
